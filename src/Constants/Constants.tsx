...
export const SKILL_LIST = [
  ...
  },
  {
    ...
    skills: [
      ...
      { path: resolvePublicAsset("skills/render.svg"), title: "Render" },
      {
...
export const PROJECTS = [
...

  {
    ...
    description:
      "Full-stack pizzéria app rendelési és admin funkciókkal, Nextjs kliens + Server Actions / API Routes + PostgreSQL perzisztencia (részletek a repo README-ben).",
  },

  {
    preview: "https://fullstack-gallery-app.vercel.app",
